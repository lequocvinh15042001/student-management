  ...
  return (
    <div>
      ...
      <div className='mt-6'>
        ...
        focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 
          ...
          <ul className='inline-flex -space-x-px'>
            <li>
              {page === 1 ? (
                ...
                <Link className='cursor-not-allowed rounded-l-lg border
                 border-gray-300 bg-white py-2 px-3 leading-tight text-gray-500
